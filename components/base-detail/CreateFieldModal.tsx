...
interface CreateFieldModalProps {
  isOpen: boolean;
  onClose: () => void;
  onCreateField: (fieldData: { name: string; type: FieldType; options?: Record<string, unknown> }) => void;
}
...
export const CreateFieldModal = ({ isOpen, onClose, onCreateField }: CreateFieldModalProps) => {
