...
export const DeleteTableModal = ({ isOpen, onClose, onDeleteTable, tableName }: DeleteTableModalProps) => {
      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Delete Table</h2>
          </div>
          <button
            onClick={handleClose}
            disabled={isDeleting}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="mt-2 text-sm text-red-700 space-y-1">
                    ...
                    <li>• All fields and their configurations</li>
                    <li>• All automations associated with this table</li>
                  </ul>
                </div>
              </div>
            </div>
