...
export const DeleteFieldModal = ({ isOpen, onClose, onDeleteField, field }: DeleteFieldModalProps) => {
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-red-700">
                    This action cannot be undone. All data in this field will be permanently deleted.
                  </p>
                </div>
              </div>
            </div>
